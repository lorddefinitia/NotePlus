...
WcharMbcsConvertor * WcharMbcsConvertor::getInstance()  {return _pSelf;};
void WcharMbcsConvertor::destroyInstance()  {delete _pSelf;};
const char * WcharMbcsConvertor::encode(UINT fromCodepage, UINT toCodepage, const char *txt2Encode, int lenIn=-1, int *pLenOut=NULL, int *pBytesNotProcessed=NULL)  {
		int lenWc = 0;
