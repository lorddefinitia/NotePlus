...
static FileManager * FileManager::getInstance()  {return _pSelf;};
void FileManager::destroyInstance()  { delete _pSelf; };
void FileManager::increaseDocNr()  {_nextNewNumber++;};
const TCHAR * Buffer::getFullPathName() const  {
		return _fullPathName.c_str();
	};

const TCHAR * Buffer::getFileName() const  { return _fileName; };
...
long Buffer::getRecentTag() const  {
		return _recentTag;
	};
...
bool Buffer::getFileReadOnly() const  {
...
bool Buffer::getUserReadOnly() const  {
...
formatType Buffer::getFormat() const  {
		return _format;
	};

void Buffer::setFormat(formatType format)  {
		_format = format;
		doNotify(BufferChangeFormat);
	};

LangType Buffer::getLangType() const  {
		return _lang;
	};
...
bool Buffer::isUserDefineLangExt() const  {
		return (_userLangExt[0] != '\0');
	};

const TCHAR * Buffer::getUserDefineLangName() const  {
...
bool Buffer::getNeedReload()  {
		return _needReloading;
	}

void Buffer::setNeedReload(bool reload)  {
		_needReloading = reload;
	}

int Buffer::docLength() const  {
