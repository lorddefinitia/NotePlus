...
void UserDefineDialog::setScintilla(ScintillaEditView *pScinView)  {
        _pScintilla = pScinView;
    };

void UserDefineDialog::create(int dialogID, bool isRTL = false)  {
...
int UserDefineDialog::getWidth() const  {
        return _dlgPos.right;
    };

int UserDefineDialog::getHeight() const  {
...
bool UserDefineDialog::isDocked() const  {return _status == DOCK;};
void UserDefineDialog::setDockStatus(bool isDocked)  {_status = isDocked;};
bool UserDefineDialog::isDirty() const  {return _isDirty;};
HWND UserDefineDialog::getFolderHandle()  {
        return _folderStyleDlg.getHSelf();
    };

HWND UserDefineDialog::getKeywordsHandle()  {
        return _keyWordsStyleDlg.getHSelf();
    };

HWND UserDefineDialog::getCommentHandle()  {
        return _commentStyleDlg.getHSelf();
    };

HWND UserDefineDialog::getSymbolHandle()   {
        return _symbolsStyleDlg.getHSelf();
    };

void UserDefineDialog::setTabName(int index, const TCHAR *name2set)  {
...
void UserDefineDialog::restorePosSize() {reSizeTo(_dlgPos);};
void UserDefineDialog::setKeywords2List(int) {};
void StringDlg::init(HINSTANCE hInst, HWND parent, TCHAR *title, TCHAR *staticName, TCHAR *text2Set, int txtLen = 0)  {
...
StylerDlg::StylerDlg( HINSTANCE hInst, HWND parent, int stylerIndex = 0, int enabledNesters = -1):
