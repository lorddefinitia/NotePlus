...
int LastRecentFileList::getSize() const  {
		return _size;
	};
...
int LastRecentFileList::getUserMaxNbLRF() const  {
		return _userMax;
	};

void LastRecentFileList::setLock(bool lock)  {
		_locked = lock;
	};

void LastRecentFileList::setLangEncoding(int nativeLangEncoding)  {
		_nativeLangEncoding = nativeLangEncoding;
	};

bool LastRecentFileList::isSubMenuMode() const  {
