...
STDMETHODIMP CShellExtClassFactory::HandleMenuMsg(UINT uMsg, WPARAM wParam, LPARAM lParam)  { return HandleMenuMsg2(uMsg, wParam, lParam, NULL); };
STDMETHODIMP CShellExtClassFactory::GetClassID(CLSID *)					 { return E_NOTIMPL; };
STDMETHODIMP CShellExtClassFactory::IsDirty(void)									 { return E_NOTIMPL; };
STDMETHODIMP CShellExtClassFactory::Save(LPCOLESTR, BOOL)	 { return E_NOTIMPL; };
STDMETHODIMP CShellExtClassFactory::SaveCompleted(LPCOLESTR)			 { return E_NOTIMPL; };
STDMETHODIMP CShellExtClassFactory::GetCurFile(LPOLESTR *)				 { return E_NOTIMPL; };
