...
public:
	...
	*/
	...
	#ifdef TIXML_USE_STL
TiXmlHandle  FirstChild ( const generic_string& _value );
TiXmlHandle  FirstChildElement ( const generic_string& _value );

TiXmlHandle  Child ( const generic_string& _value, int index );
TiXmlHandle  ChildElement ( const generic_string& _value, int index );
	#endif
