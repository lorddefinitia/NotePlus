...
CALLBACK int wndCaptionProc (HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam);

	// Subclassing tab
	LRESULT runProcTab(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam);
CALLBACK int wndTabProc (HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam);
