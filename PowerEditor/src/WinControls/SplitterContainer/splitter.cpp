...
//NOTE Manually added
Splitter::~Splitter(){};
int Splitter::getPhysicalSize() const {
	return _spiltterSize;
};
bool Splitter::isVertical() const {return (_dwFlags & SV_VERTICAL) != 0;};
