...
void SplitterContainer::display(bool toShow = true) const  {
...
void SplitterContainer::setWin0(Window *pWin)  {
        _pWin0 = pWin;

    };

void SplitterContainer::setWin1(Window *pWin)  {
        _pWin1 = pWin;
    };

bool SplitterContainer::isVertical() const  {
