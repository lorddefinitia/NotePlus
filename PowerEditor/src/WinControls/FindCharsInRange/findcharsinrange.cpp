...
void FindCharsInRangeDlg::create(int dialogID, bool isRTL = false)  {
		StaticDialog::create(dialogID, isRTL);
	};

void FindCharsInRangeDlg::doDialog(bool isRTL = false)  {
		if (!isCreated())
			create(IDD_FINDCHARACTERS, isRTL);
		display();
	};

void FindCharsInRangeDlg::display(bool toShow = true) const  {
