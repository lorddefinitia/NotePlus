...
void URLCtrl::create(HWND itemHandle, TCHAR * link, COLORREF linkColor)
{
	...
	//FIXME LONG_PTR -> void*
    _oldproc = (WNDPROC)::SetWindowLongPtr(itemHandle, GWLP_WNDPROC, (void*)&URLCtrlProc);
...
static LRESULT CALLBACK URLCtrl::URLCtrlProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam){
