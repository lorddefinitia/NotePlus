...
void TreeView::init(HINSTANCE hInst, HWND parent, int treeViewID)
{
	...
	//FIXME fncpntr
	_defaultProc = reinterpret_cast<WNDPROC>(::SetWindowLongPtr(_hSelf, GWLP_WNDPROC, (void*)&staticProc));
}
...
static LRESULT CALLBACK TreeView::staticProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
