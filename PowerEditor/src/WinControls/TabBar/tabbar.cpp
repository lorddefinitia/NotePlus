...
void TabBarPlus::init(HINSTANCE hInst, HWND parent, bool isVertical, bool isTraditional, bool isMultiLine)
{
	...
	if (!_isTraditional)
    {
        ...
        //FIXME fncpntr
	    _tabBarDefaultProc = reinterpret_cast<WNDPROC>(::SetWindowLongPtr(_hSelf, GWLP_WNDPROC, (void*)&TabBarPlus_Proc));
    }
...
int TabBar::nbItem() const  {
        return _nbItem;
    };

void TabBar::setVertical(bool b)  {
		_isVertical = b;
	};

void TabBar::setMultiLine(bool b)  {
		_isMultiLine = b;
	};
...
static void TabBarPlus::doDragNDrop(bool justDoIt)  {
        _doDragNDrop = justDoIt;
    };

static bool TabBarPlus::doDragNDropOrNot()  {
        return _doDragNDrop;
    };

int TabBarPlus::getSrcTabIndex() const  {
        return _nSrcTab;
    };

int TabBarPlus::getTabDraggedIndex() const  {
        return _nTabDragged;
    };

POINT TabBarPlus::getDraggingPoint() const  {
		return _draggingPoint;
	};

void TabBarPlus::resetDraggingPoint()  {
		_draggingPoint.x = 0;
		_draggingPoint.y = 0;
	};

static bool TabBarPlus::isOwnerDrawTab()  {return true;};
static bool TabBarPlus::drawTopBar()  {return _drawTopBar;};
static bool TabBarPlus::drawInactiveTab()  {return _drawInactiveTab;};
static bool TabBarPlus::drawTabCloseButton()  {return _drawTabCloseButton;};
static bool TabBarPlus::isDbClk2Close()  {return _isDbClk2Close;};
static bool TabBarPlus::isVertical()  { return _isCtrlVertical;};
static bool TabBarPlus::isMultiLine()  { return _isCtrlMultiLine;};
static void TabBarPlus::setDrawTopBar(bool b)  {
		_drawTopBar = b;
		doOwnerDrawTab();
	};

static void TabBarPlus::setDrawInactiveTab(bool b)  {
		_drawInactiveTab = b;
		doOwnerDrawTab();
	};

static void TabBarPlus::setDrawTabCloseButton(bool b)  {
		_drawTabCloseButton = b;
		doOwnerDrawTab();
	};

static void TabBarPlus::setDbClk2Close(bool b)  {
		_isDbClk2Close = b;
	};

static void TabBarPlus::setVertical(bool b)  {
		_isCtrlVertical = b;
		doVertical();
	};

static void TabBarPlus::setMultiLine(bool b)  {
		_isCtrlMultiLine = b;
		doMultiLine();
	};

CALLBACK TabBarPlus::TabBarPlus_Proc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam)  {
		return (((TabBarPlus *)(::GetWindowLongPtr(hwnd, GWL_USERDATA)))->runProc(hwnd, Message, wParam, lParam));
	};

int TabBarPlus::getTabIndexAt(const POINT & p)  {
