...
void FileDialog::setDefFileName(const TCHAR *fn){lstrcpy(_fileName, fn);}
void FileDialog::setExtIndex(int extTypeIndex) {_extTypeIndex = extTypeIndex;};
bool FileDialog::isReadOnly() {return _ofn.Flags & OFN_READONLY;};
