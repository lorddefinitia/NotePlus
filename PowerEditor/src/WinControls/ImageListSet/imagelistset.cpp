...
IconList::IconList() : _hImglst(NULL) {};
IconList::~IconList() {};

HIMAGELIST IconList::getHandle() const {return _hImglst;};
...
IconLists::IconLists() {};
IconLists::~IconLists() {};
HIMAGELIST IconLists::getImageListHandle(int index) const {
	return _iconListVector[index].getHandle();
};

HIMAGELIST ToolBarIcons::getDefaultLst() const {
	return IconLists::getImageListHandle(HLIST_DEFAULT);
};

HIMAGELIST ToolBarIcons::getHotLst() const {
	return IconLists::getImageListHandle(HLIST_HOT);
};

HIMAGELIST ToolBarIcons::getDisableLst() const {
	return IconLists::getImageListHandle(HLIST_DISABLE);
};

unsigned int ToolBarIcons::getNbCommand() const {return _nbCmd;};
int ToolBarIcons::getCommandAt(int index) const {return _cmdArray[index];};
void ToolBarIcons::resizeIcon(int size) {
	reInit(size);
};

int ToolBarIcons::getNbIcon() const {
