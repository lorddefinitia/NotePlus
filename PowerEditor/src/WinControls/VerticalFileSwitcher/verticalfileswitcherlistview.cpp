...
void VerticalFileSwitcherListView::setBgColour(int i)  {
...
CALLBACK VerticalFileSwitcherListView::staticProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam)  {
